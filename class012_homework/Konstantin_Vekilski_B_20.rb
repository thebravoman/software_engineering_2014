...
p "git log working...(vh)"
								if !git_log.empty? and hashstudents["#{name[0]}".capitalize + " " + "#{name[1]}".capitalize]>=1 then						p "#{myfile} is in time(vh)"
