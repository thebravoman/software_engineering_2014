=begin
	Develop a program named FirstName_LastName_ClassNumber_879524.rb
...
first_folder_files.each do |element|
	...
	second_folder_files.each do |element2|
		first_name_2 = element2.split("_")[0]
		last_name_2 = element2.split("_")[1]
		if "#{first_name_1} + #{last_name_1}" == "#{first_name_2} + #{last_name_2}"
			exists_twice = true
		end
	end
