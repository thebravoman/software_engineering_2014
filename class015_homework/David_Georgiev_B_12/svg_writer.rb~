class SVGWriter
	def write (num_of_hashes,hashstudents_vhodno,hashstudents_002,hashstudents_003,hashstudents_004,hashstudents_009,hashstudents_012,hashstudents_014,hashstudents_015)
		count = Array.new
...
=begin		hashstudents_vhodno.each	do |key, value| if value == 1 then count[1] = count[1]+1 end end
...
#The following is for all of the points
		...
		svg.puts "<text x=\"#{x_text}\" y=\"385\" style=\"fill: #999999; stroke: #000000;  font-size: 16px;\">VH</text>"
		...
		svg.puts "<text x=\"#{x_points}\" y=\"#{380-info_for_bars[index][0]}\" style=\"fill: #594e52; font-size: 16px;\">#{info_for_bars[index][1]}</text>\n"
		svg.puts "<svg x=\"0\" y=\"#{380-info_for_bars[index][0]}\">\n<rect x=\"#{x_rect}\" y=\"10\" height=\"#{info_for_bars[index][0]}\" width=\"90\"\nrx=\"20\" ry=\"10\"\nstyle=\"stroke:#594e52;\nstroke-width: 3;\nfill:#e29676;\nbackground: red;\"/>\n</svg>"
		svg.puts "<text x=\"#{x_text}\" y=\"385\" style=\"fill: #999999; stroke: #000000;  font-size: 16px;\">002</text>"
		...
		svg.puts "<text x=\"#{x_points}\" y=\"#{380-info_for_bars[index][0]}\" style=\"fill: #594e52; font-size: 16px;\">#{info_for_bars[index][1]}</text>\n"
		svg.puts "<svg x=\"0\" y=\"#{380-info_for_bars[index][0]}\">\n<rect x=\"#{x_rect}\" y=\"10\" height=\"#{info_for_bars[index][0]}\" width=\"90\"\nrx=\"20\" ry=\"10\"\nstyle=\"stroke:#594e52;\nstroke-width: 3;\nfill:#e29676;\nbackground: red;\"/>\n</svg>"
		svg.puts "<text x=\"#{x_text}\" y=\"385\" style=\"fill: #999999; stroke: #000000;  font-size: 16px;\">003</text>"
		...
		svg.puts "<text x=\"#{x_points}\" y=\"#{380-info_for_bars[index][0]}\" style=\"fill: #594e52; font-size: 16px;\">#{info_for_bars[index][1]}</text>\n"
		svg.puts "<svg x=\"0\" y=\"#{380-info_for_bars[index][0]}\">\n<rect x=\"#{x_rect}\" y=\"10\" height=\"#{info_for_bars[index][0]}\" width=\"90\"\nrx=\"20\" ry=\"10\"\nstyle=\"stroke:#594e52;\nstroke-width: 3;\nfill:#e29676;\nbackground: red;\"/>\n</svg>"
		svg.puts "<text x=\"#{x_text}\" y=\"385\" style=\"fill: #999999; stroke: #000000;  font-size: 16px;\">004</text>"
		...
		svg.puts "<text x=\"#{x_points}\" y=\"#{380-info_for_bars[index][0]}\" style=\"fill: #594e52; font-size: 16px;\">#{info_for_bars[index][1]}</text>\n"
		svg.puts "<svg x=\"0\" y=\"#{380-info_for_bars[index][0]}\">\n<rect x=\"#{x_rect}\" y=\"10\" height=\"#{info_for_bars[index][0]}\" width=\"90\"\nrx=\"20\" ry=\"10\"\nstyle=\"stroke:#594e52;\nstroke-width: 3;\nfill:#e29676;\nbackground: red;\"/>\n</svg>"
		svg.puts "<text x=\"#{x_text}\" y=\"385\" style=\"fill: #999999; stroke: #000000;  font-size: 16px;\">009</text>"
		...
		svg.puts "<text x=\"#{x_points}\" y=\"#{380-info_for_bars[index][0]}\" style=\"fill: #594e52; font-size: 16px;\">#{info_for_bars[index][1]}</text>\n"
		svg.puts "<svg x=\"0\" y=\"#{380-info_for_bars[index][0]}\">\n<rect x=\"#{x_rect}\" y=\"10\" height=\"#{info_for_bars[index][0]}\" width=\"90\"\nrx=\"20\" ry=\"10\"\nstyle=\"stroke:#594e52;\nstroke-width: 3;\nfill:#e29676;\nbackground: red;\"/>\n</svg>"
		svg.puts "<text x=\"#{x_text}\" y=\"385\" style=\"fill: #999999; stroke: #000000;  font-size: 16px;\">012</text>"
		...
		svg.puts "<text x=\"#{x_points}\" y=\"#{380-info_for_bars[index][0]}\" style=\"fill: #594e52; font-size: 16px;\">#{info_for_bars[index][1]}</text>\n"
		svg.puts "<svg x=\"0\" y=\"#{380-info_for_bars[index][0]}\">\n<rect x=\"#{x_rect}\" y=\"10\" height=\"#{info_for_bars[index][0]}\" width=\"90\"\nrx=\"20\" ry=\"10\"\nstyle=\"stroke:#594e52;\nstroke-width: 3;\nfill:#e29676;\nbackground: red;\"/>\n</svg>"
		svg.puts "<text x=\"#{x_text}\" y=\"385\" style=\"fill: #999999; stroke: #000000;  font-size: 16px;\">014</text>"
		...
		svg.puts "<text x=\"#{x_points}\" y=\"#{380-info_for_bars[index][0]}\" style=\"fill: #594e52; font-size: 16px;\">#{info_for_bars[index][1]}</text>\n"
		svg.puts "<svg x=\"0\" y=\"#{380-info_for_bars[index][0]}\">\n<rect x=\"#{x_rect}\" y=\"10\" height=\"#{info_for_bars[index][0]}\" width=\"90\"\nrx=\"20\" ry=\"10\"\nstyle=\"stroke:#594e52;\nstroke-width: 3;\nfill:#e29676;\nbackground: red;\"/>\n</svg>"
		svg.puts "<text x=\"#{x_text}\" y=\"385\" style=\"fill: #999999; stroke: #000000;  font-size: 16px;\">015</text>"
