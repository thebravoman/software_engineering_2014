...
Dir.glob("/home/krassen/software_engineering_2014/vhodno_nivo/*") do |my_folder|
	#puts "#{my_folder}"
	name_folder_user = my_folder.split('/')[-1]
	name = "#{name_folder_user.split('_')[0]} #{name_folder_user.split('_')[1]}" 
	#puts name
	Dir.glob("/home/krassen/software_engineering_2014/vhodno_nivo/#{name_folder_user}/*.*") do |my_text_file|
		#puts "#{my_text_file}"
