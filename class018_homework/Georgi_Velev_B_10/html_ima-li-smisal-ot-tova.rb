		...
		File.open("results_Georgi_Velev_B_10.html","w") do |line|
			...
			whatever.keys.sort.each do |key|
				line.puts "<tr>"
					...
					line.puts  "<td>#{whatever[key][6]}</td>"
					line.puts  "<td>#{whatever[key][7]}</td>"
					line.puts  "<td>#{whatever[key][8]}</td>"
					line.puts  "<td>#{whatever[key][9]}</td>"
					line.puts  "<td>#{whatever[key][10]}</td>"
					line.puts  "<td>#{whatever[key][11]}</td>"
					line.puts  "<td>#{whatever[key][12]}</td>"
					line.puts  "<td>#{whatever[key][13]}</td>"
					line.puts  "<td>#{whatever[key][14]}</td>"
					line.puts  "<td>#{whatever[key][15]}</td>"
					line.puts  "<td>#{whatever[key][16]}</td>"
					line.puts  "<td>#{whatever[key][17]}</td>"
					line.puts  "<td>#{whatever[key][18]}</td>"
					line.puts  "<td>#{whatever[key][19]}</td>"
					#line.puts  "</span>"
				line.puts"</tr>"
			end
