=begin
Develop a program named FirstName_LastName_ClassNumber_5b868a.rb
...
3. find all the students that have less than 8 symbols in their second name and their number is odd;
...
require_relative 'Stanislav_Valkanov_25_5b868a_csv_writer.rb'
student = Hash.new()
