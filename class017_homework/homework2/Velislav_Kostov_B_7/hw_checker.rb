...
class HWChecker
    ...
    def start()
        @@names_team_result.each_pair do |key, v|
            ...
            sort_stats(file_stat?("class017_homework/homework1/", "02.12.2014:06:00:00", key, true, "*_*_*_*.rb", 1), results, flogs, flays)
            sort_stats(file_stat?("class017_homework/homework2/", "02.12.2014:06:00:00", key, true, "*_*_*_*.rb", 1), results, flogs, flays)
        ...
        if(writer != nil)
            writer.write(@@names_team_result,[@@duration,"","VH", "002", "003", "004", "009", "012", "014", "017_1", "017_2", "g2", "g3", "g4", "g12", "g14", "g17_1", "g17_2", "y2", "y3", "y4", "y12", "y14", "y17_1", "y17_2"])
        end
    end
end
