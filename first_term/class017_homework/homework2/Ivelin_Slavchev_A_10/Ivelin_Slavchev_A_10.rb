...
def parseDir location, time, results, index, flog_index, flay_index
	Dir.glob(ARGV[0] + "#{location}/**/*_*_*_*.rb").each do |file|		
		...
		if location == "class014_homework" or location == "class015_homework" or location == "class017_homework/homework2"
...
parseDir "class002_homework", "Sep-22-2014-20:00:00", results, 1, 10, 18
parseDir "class003_homework", "Sep-24-2014-20:00:00", results, 2, 11, 19
parseDir "class004", "Sep-29-2014-20:00:00", results, 3, 12, 20
parseDir "class012_homework", "Nov-10-2014-20:00:00", results, 5, 13, 21
parseDir "class014_homework", "Nov-13-2014-06:00:00", results, 6, 14, 22
parseDir "class015_homework", "Nov-20-2014-06:00:00", results, 7, 15, 23
parseDir "class017_homework/homework1", "Dec-02-2014-06:00:00", results, 8, 16, 24
parseDir "class017_homework/homework2", "Dec-02-2014-06:00:00", results, 9, 17, 25
