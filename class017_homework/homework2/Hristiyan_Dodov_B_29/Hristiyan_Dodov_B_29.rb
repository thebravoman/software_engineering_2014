...
$flogSI = 8; $flaySI = 15 # SI = Start Index
...
header = Array.new
header = ["", "", "VH",
	"002", "003", "004", "009", "012", "014", "017-1", "017-2",
	"g002", "g003", "g004", "g012", "g014", "g017-1", "g017-2",
	"y002", "y003", "y004", "y012", "y014", "y017-1", "y017-2"]
...
$students.each do |k,v|
	...
	checkStudentFiles("02.12.2014:06:00", "class017_homework/homework1/**/"+k+"*.*", k, 2, 		7,6+$flogSI,6+$flaySI)
	checkStudentFiles("02.12.2014:06:00", "class017_homework/homework2/**/"+k+"*.*", k, 2,		8,7+$flogSI,7+$flaySI)
end
