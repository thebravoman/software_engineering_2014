...
task009H	= Hash.new{|hash, key| hash[key] = []}			
task012 	= Array.new										
...
check_homeworks grades, " class017_homework/homework1/", "2.Dec.2014--06:00:00", 7,14
check_homeworks grades, " class017_homework/homework2/", "2.Dec.2014--06:00:00", 8,15
...
if ARGV[1] == "-o"
	...
	SickkuntLoop = case switcher
		...
		when "svg"
			...
			writer.write grades, running_time
		else puts "Enter another file extension brah!"
	end
end