...
if ARGV[1] == "-o"
	...
	when "csv"
		...
		writer.write(time_program, all_students, resultsVH, results002, results003, results004, results009, results012, results014, flog002, flog003, flog004, flog012, flog014)
	when "html"
