...
def check_homeworks grades, location, time, array_index, additional_index
	Dir.glob("#{ARGV[0]}#{location}**/*_*_*_*.rb") do |task| 
		...
		if flay.to_i != ""
			grades["#{name}"][additional_index+5] = flog
		end
...
check_homeworks grades, "class002_homework/", "22.Sep.2014--20:00:00", 1, 7
check_homeworks grades, "class003_homework/", "24.Sep.2014--20:00:00", 2, 8
check_homeworks grades, "class004/", "29.Sep.2014--20:00:00", 3, 9
check_homeworks grades, "class012_homework/", "10.Nov.2014--20:00:00", 5, 10
check_homeworks grades, "class014_homework/*/", "13.Nov.2014--06:00:00", 6, 11
