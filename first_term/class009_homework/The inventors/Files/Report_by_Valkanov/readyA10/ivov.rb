...
Dir.glob("#{ARGV[0]}*.*") do |file|
    ...
    if (name.size == 3)&&(name[0].length==5)
...
#23: syntax error, unexpected tIDENTIFIER, expecting keyword_then or ';' or '\n' ...== 5 and !isNum!=nil hash_fold1.include?(name[0]) ... ^ ../results/a/results/Ivo_Valchev_11_6c8bd9.rb:26: syntax error, unexpected keyword_end, expecting $end 
*Unfixed*
